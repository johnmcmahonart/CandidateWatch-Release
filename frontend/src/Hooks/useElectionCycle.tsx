...
export function useElectionCycle(candidateId: string, year: number): FinanceTotalsDto | boolean {
    ...
    let financeDataCycleA = useGetApiFinanceTotalsByKeyYearsQuery({ key: candidateId, years: [year], state:"MD" })
    let financeDataCycleB = useGetApiFinanceTotalsByKeyYearsQuery({ key: candidateId, years: [year + 2], state:"MD" })
