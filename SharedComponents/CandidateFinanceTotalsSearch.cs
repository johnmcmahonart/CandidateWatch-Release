...
namespace FECIngest
{
    public class CandidateFinanceTotalsSearch : IFECSearch
    {
        ...
        public List<CandidateHistoryTotal> FinanceTotals => _candidateFinanceTotals;
        private Configuration _configuration;
        private List<CandidateHistoryTotal> _candidateFinanceTotals = new List<CandidateHistoryTotal>();
        ...
        public async Task<bool> Submit()
        {
            ...
            foreach (var total in page.Results)
            {
                _candidateFinanceTotals.Add(total);
            }
